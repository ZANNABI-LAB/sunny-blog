    ...
    >
      ...
      >
        <input
          ...
          disabled={isLoading}
          aria-label="메시지 입력"
          className="flex-1 rounded-full border border-border bg-card px-4 py-2 text-base text-text-primary placeholder-text-muted transition-colors focus:border-accent/50 focus:outline-none focus:ring-1 focus:ring-accent/30 disabled:opacity-50"
        />
        <button
          type="submit"
