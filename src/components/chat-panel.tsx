...
const ChatPanel = ({ messages, isLoading, onSend, onClose }: ChatPanelProps) => {
  ...
  return (
    <div
      className="fixed inset-4 z-[60] flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/95 shadow-2xl shadow-black/50 backdrop-blur-sm sm:inset-auto sm:bottom-24 sm:right-6 sm:h-[520px] sm:w-[380px]"
