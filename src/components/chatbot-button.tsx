...
const ChatbotButton = ({ isOpen, onClick, ref }: ChatbotButtonProps) => {
  return (
    <button
      ...
      className="fixed bottom-24 right-6 z-[60] flex items-center justify-center gap-2 w-14 h-14 md:w-auto md:h-auto rounded-full border border-accent/20 bg-bg-elevated/90 md:px-4 md:py-3 text-text-primary backdrop-blur-sm transition-all duration-200 hover:border-accent/40 focus-visible:ring-2 focus-visible:ring-amber-400/50 focus-visible:outline-none"
      style={{
