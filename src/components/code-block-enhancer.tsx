...
const CodeBlockEnhancer = () => {
  useEffect(() => {
    ...
    pres.forEach((pre) => {
      ...
      btn.style.cssText =
        "position:absolute;top:8px;right:8px;width:32px;height:32px;display:flex;align-items:center;justify-content:center;border-radius:6px;border:1px solid var(--border-subtle);background:var(--bg-elevated);opacity:0.8;color:var(--text-muted);cursor:pointer;transition:opacity 150ms;";
