    ...
    <div className="max-w-4xl mx-auto animate-page-fade-in space-y-16">
      ...
      <header className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-4 text-text-secondary text-sm md:text-base leading-relaxed max-w-lg">
            TBD
          </p>
        </div>
      </header>
      ...
      <section>
        ...
        <div className="border border-border rounded-lg p-6 bg-card flex flex-wrap gap-4">
          <a
            href="https://github.com/ZANNABI-LAB"
            target="_blank"
            rel="noopener noreferrer"
            className="font-display text-xs tracking-wider text-text-secondary hover:text-accent transition-colors border border-border rounded px-3 py-2"
          >
            GitHub
          </a>
          <a
